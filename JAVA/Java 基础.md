...
![image-20220427232204936](appendix\Java 基础\image-20220427232204936.png)
...
- 你可以把List<String>传递给一个接受List<Object>参数的方法吗？
  ...
  > ```
  >
  > 不可以，参数化类型不考虑类型参数的继承关系。编译器不允许创建泛型变量的数组。即在创建数组实例时，数组的元素不能使用参数化的类型
...
![image-20220427223140914](appendix\Java 基础\image-20220427223140914.png)
